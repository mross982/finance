...
if __name__ == "__main__":
        ...
        dt_end = dt.datetime(2017,1,31)
        ls_symbols = ['DODGX', 'BAGIX', 'JDMNX', 'DIMVX']
        ls_allocation = [0.2, 0.3, 0.4, 0.1]

        max_alloc = brains.optimal_allocation_4( dt_start, dt_end, ls_symbols )
        brains.print_simulate( dt_start, dt_end, ls_symbols, max_alloc )

        # Example 2
        # dt_start = dt.datetime(2010,1,1)
        # dt_end = dt.datetime(2010,12,31)
        # ls_symbols = ['AXP', 'HPQ', 'IBM', 'HNZ']
        # ls_allocation = [0.2, 0.4, 0.2, 0.2]
